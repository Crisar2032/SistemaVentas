<template>
  <v-app id="inspire">
    ...
    >
      <v-list dense>
        ...
        <template v-if="esAdministrador || esAlmacenero">
            <v-list-group prepend-icon="account_balance_wallet">
            <v-list-tile slot="activator">
              <v-list-tile-content>
                <v-list-tile-title>
                  Compras
        ...
        <template v-if="esAdministrador">
            ...
            <v-list-tile :to="{ name: 'consultacompra'}">
              <v-list-tile-action>
                <v-icon>table_chart</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
            ...
            <v-list-tile :to="{ name: 'consultaventa'}">
              <v-list-tile-action>
                <v-icon>table_chart</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
  ...
  <!--Snackbar Registro Guardado -->
    ...
    >
      ...
      <v-spacer></v-spacer>
      <v-btn color="primary" small @click="salir" v-if="logueado">
        <v-icon left>logout</v-icon>Salir
      </v-btn>
      <v-btn :to="{name: 'login'}" v-else>
        <v-icon left>apps</v-icon>Login
      </v-btn>
    ...
    <v-content>
      <v-container fluid fill-height>
        <v-slide-y-transition mode="out-in">
          <router-view @registroGuardado="snackbar=true"/>
