    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                <v-btn flat icon @click="crearPDF"><v-icon>print</v-icon></v-btn>   
                        ...
                        <v-form ref="form">
                            <v-card>
                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                    <v-flex xs6 sm6 md6>
                                        <v-text-field v-model="codigo" label="Código" maxlength="50" :rules="inputRules"></v-text-field>
                                    </v-flex>
                                    <v-flex xs6 sm6 md6>
                                        <v-select v-model="idcategoria" :items="categorias" label="Categoría" :rules="inputRules">
                                        </v-select>
                                    </v-flex>
                                    ...
                                    <v-flex xs6 sm6 md6>
                                        ...
                                        :rules="[v => !!v  || 'Ingrese el stock inicial del artículo',
                                        v=> v && v>0 || 'El stock debe ser mayor a 0']"></v-text-field>
                                    </v-flex>
                                    <v-flex xs6 sm6 md6>
                                        <v-text-field type="number" prefix="$" v-model="precio_venta" label="Precio de venta"
                                        :rules="[v => !!v || 'Ingrese el precio de venta del artículo',
                                        v=> v && v>0 || 'El precio debe ser mayor a 0']"></v-text-field>
                                    </v-flex>
                                    <v-flex xs12 sm12 md12>
        ...
        methods:{
            crearPDF(){
                ...
                this.articulos.map(function(x){
                    body.push({nombre:x.nombre, codigo:x.codigo, categoria:x.categoria,stock:x.stock,precio_venta:x.precio_venta})
                });
