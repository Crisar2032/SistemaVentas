            ...
            <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
                ...
                <v-layout row wrap >
                        ...
                        <v-flex xs12 sm8 md8 lg8 xl8>
                            ...
                            :items="proveedores" label="Proveedor" :rules="[v => !!v || 'Seleccione un Proveedor']" :readonly="readonly">
                            </v-select>
                        </v-flex>
                        <v-flex xs12 sm4 md4 lg4 xl4>
                    ...
                    <v-flex xs12 sm12 md12 lg12 xl12>
                        ...
                        >
                            <template v-slot:items="props">
                                ...
                                <td><v-text-field type="number" v-model="props.item.cantidad" :readonly="readonly"></v-text-field></td>
                                <td><v-text-field type="number" prefix="$" v-model="props.item.precio" :readonly="readonly"></v-text-field></td>
                                <td>$ {{ (props.item.cantidad * props.item.precio).toFixed(2)}}</td>
                            </template>
                            <template v-slot:no-data>
